...
/***/ (function(module, exports, __webpack_require__) {
	...
	Vue.use(vueResource);
	Vue.use(vueRouter);
	var commondirective=-__webpack_require__(8);
	var definedUtil=__webpack_require__(9);
	var components=__webpack_require__(10);
	var schedule=__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"views/dayReports/dayReportsManager.vue\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
