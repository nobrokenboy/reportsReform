...
<style></style>
<div class="form-reports" id="detailReportManager" v-if="isShow" v-cloak>
    <section>
        <!--头部导航栏-->
        <header-nav>
            <span slot="title" class="f16">每日行动明细</span>
        </header-nav>
        <!--导航栏-->
        <section>
...
<script src="detail_report_manager.build.js"></script>
